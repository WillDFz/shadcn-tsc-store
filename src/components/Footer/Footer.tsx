    ...
    return (
        <>
            <div className='bg-black lg:flex p-3 lg:p-5'>
                ...
                <div className='flex flex-col lg:w-1/4 items-center lg:items-start text-white space-y-3 mb-4 lg:mb-0'>
                ...
                <div className='flex flex-col items-center lg:items-start lg:w-1/4 text-white space-y-3 mb-4 lg:mb-0'>
